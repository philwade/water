...
var _user$project$Main$waterImage = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('water-img'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'src', 'water.png'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
...
var _user$project$Main$encouragementDisplay = function (model) {
	var halfway = (model.goal / 2) | 0;
	return _elm_lang$core$Native_Utils.eq(model.count, halfway) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('comment-half'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('halfway there! you got this!'),
			_1: {ctor: '[]'}
		}) : (_elm_lang$core$Native_Utils.eq(model.count, model.goal) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('comment-success'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('you did it! hell yeah!'),
			_1: {ctor: '[]'}
		}) : ((_elm_lang$core$Native_Utils.cmp(model.count, model.goal) > 0) ? A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('awwww damn getting extracurricular!'),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$span,
		{ctor: '[]'},
...
var _user$project$Main$progressDisplay = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Main$displayCount = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.count, 0) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Nothing yet, get drinking!'),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('display-emoji'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$repeat, model.count, _user$project$Main$waterImage));
};
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'hidden', _1: !model.editingGoal},
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('The standard recommendation for water is 64 oz or 1800 ml. Aka eight 8 oz glasses. Adjust your goal according to the size of your cup and goals!'),
						_1: {
							ctor: '::',
							_0: A2(
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('ok'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$CloseEditGoal),
											_1: {ctor: '[]'}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('toggle-modal'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('change goal'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$displayModal(model),
				_1: {ctor: '[]'}
			}
		});
};
